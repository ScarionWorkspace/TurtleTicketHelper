module.exports = {
    ...
    ROSTER_BACKEND_URL: process.env.ROSTER_BACKEND_URL,
    ROSTER_BOT_SECRET: process.env.ROSTER_BOT_SECRET,
    ROSTER_FIREBASE_DB_URL: process.env.ROSTER_FIREBASE_DB_URL
};