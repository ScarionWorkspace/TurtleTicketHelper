...
async function handleCaseModal(interaction, parsed) {
    ...
    if (action === 'contactform') {
        ...
        patch = {
            ...
            recoveryAverageStarsThreshold: workspace.work.settings.regularAverageStarsThreshold,
            recoveryAverageDestructionThreshold: workspace.work.settings.regularAverageDestructionThreshold,
            recoveryContextMode: workspace.work.settings.regularContextMode,
